...
const minSpread = 0.0000300;
const avgSpreadLimiter = 0.0000100;

const decimalPlace = 7;
const avlToStart = 6;
const avlMax = 7;

const currency = 'APPCETH';
const mainCurrency = 'ETH';
const secCurrency = 'APPC';

const cstRelistSell = -0.0000070;
const cstReSellLimit = -0.0000001;

const cstStopLossStart = -0.0000150;
...
const buyPad = 0.0000020;
const sellPad = 0.0000020;
